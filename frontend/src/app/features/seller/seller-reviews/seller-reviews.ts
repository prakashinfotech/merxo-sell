...
@Component({
  ...
  standalone: false,
  templateUrl: './seller-reviews.html',
  styleUrls: ['./seller-reviews.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SellerReviews implements OnInit {
  ...
  load(): void {
    this.loading = true;
    this.reviewsService.getSellerReviews(this.searchTerm.trim() || undefined, this.ratingFilter || undefined).subscribe({
      next: reviews => {
